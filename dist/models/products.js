...
exports.initializeProductTables = exports.createProduct = exports.getProducts = void 0;
...
`;
const initializeProductTables = () => __awaiter(void 0, void 0, void 0, function* () {
    yield pool.query(createProductTablesQuery);
});
exports.initializeProductTables = initializeProductTables;
const getProducts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
    try {
        const noSKUsResults = yield pool.query(getProductsNoSKUsQuery);
        ...
        const SKUsResults = yield pool.query(getProductsSKUsQuery);
...
const createProduct = (productInput) => __awaiter(void 0, void 0, void 0, function* () {
    const detectDuplicates = (arr, objectName, fieldName) => {
        arr.reduce((prev, cur) => {
    ...
    const createProductQuery = `
        ...
        COMMIT TRANSACTION;
    `;
    const productId = (yield pool.query(createProductQuery)).find(result => result.command == 'SELECT').rows[0].productId;
    return Object.assign({ productId }, productInput);
});
